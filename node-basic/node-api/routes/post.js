...
router.get('/post', UserController.requireSignin, PostController.getPosts);
...
router.put('/post/:postId', UserController.requireSignin, PostController.isPoster, PostController.updatePost);
